...
through 2026-07-24. Historical monthly calculations use completed months
through 2026-06-30, with the 2026-07-24 Close used separately as the
provisional July model input. One invalid source row with a non-positive High
is excluded before the log and event calculations.
...
Using the 2026-07-24 VIX Close of 18.58:

- relative Log deviation: 0.0183;
- VIX Z-score: 0.111;
- bounded normal-score: 54.43%.
...
VIX represents higher complacency risk.
